...
add_action("wp_ajax_bkbm_rkbur_installation_counter", "bkbmRkburAddInstallationData");
add_action("wp_ajax_nopriv_bkbm_rkbur_installation_counter", "bkbmRkburAddInstallationData");

function bkbmRkburApiUrl()
{
...
function bkbmRkburAddInstallationData()
{

  // bkbm_rkbur_installation
  $apiURL = bkbmRkburApiUrl();
