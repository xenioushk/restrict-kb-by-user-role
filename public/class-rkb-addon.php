...
class BKB_Rkb {
    ...
    private function __construct() {
        ...
        if ( class_exists( 'BwlKbManager\\Init' ) && BKBRKB_PARENT_PLUGIN_INSTALLED_VERSION > '1.0.5' && BKBRKB_PARENT_PLUGIN_PURCHASE_STATUS == 1 ) {
            ...
            add_filter( 'bkb_rkb_blog_query_filter', [ $this, 'bkb_rkb_blog_query_filter' ] );
            add_filter( 'bkb_rkb_search_query_filter', [ $this, 'bkb_rkb_search_query_filter' ] );
        }
    }
    ...
    public function bkb_rkb_modify_taxonomy_exceprt( $content ) {
        ...
        } elseif ( ! is_admin() && is_tax( 'bkb_tags' ) && isset( $bkb_data['bkb_tag_default_tpl_ordering_status']['enabled'] ) && $bkb_data['bkb_tag_default_tpl_ordering_status']['enabled'] == 'on' ) {
